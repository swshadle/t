...
#     quote, person, tweet_id = get_breaking_news(30)
#     if tweet_id:
#         print(quote, '-', person, tweet_id)
    ...
    author_x = quote_x = (w - max_width) / 2
    quote_y = ((h - max_height) + (max_height - p_h - author_font.getsize("ABCD ")[1])) / 2
    # author_y = ((h - max_height) + (max_height - p_h - author_font.getsize("ABCD ")[1])) / 2

    # x- and y-coordinates for the top left of the author

    author_y = quote_y + p_h
    # quote_y = author_y + author_font.getsize(person)[1] + 10
    ...
    # draw.rectangle((padding / 4, padding / 4, w - (padding / 4), author_y - (padding / 4)), fill=inky_display.RED)
    # 
    # print('quote:', quote)
    # print('quote height:', quote_font.getsize(quote)[1])
    # print('block height:', p_h)
    # 
    # draw.rectangle((padding / 4, quote_y + p_h + (padding / 4) + 5, w - (padding / 4), h - (padding / 4)), fill=inky_display.RED)
...
if __name__ == "__main__":
    tweet, user, tweet_id = get_breaking_news(300)
    if tweet_id:
